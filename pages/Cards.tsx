  ...
  return (
    <div className="min-h-screen pt-28 pb-16">
      ...
      <section className="text-center mb-20 px-4">
        <span className="text-emerald-400 font-bold uppercase tracking-widest text-sm">Crypto Cards</span>
        ...
        <p className="text-slate-400 max-w-2xl mx-auto text-lg mb-12">
           Experience the convenience of spending your crypto anywhere with Fluid Crypto Cards. Link your digital assets and enjoy fast, secure transactions.
        </p>
        ...
        <div className="relative max-w-md mx-auto perspective-1000 group">
           ...
           <div className="relative aspect-[1.586/1] rounded-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border border-slate-700/50 shadow-2xl p-6 flex flex-col justify-between transform transition-transform duration-500 group-hover:rotate-y-6 group-hover:rotate-x-6 overflow-hidden">
               ...
               <div className="flex justify-between items-start z-10">
                  <span className="font-bold text-2xl text-white italic tracking-tighter">Fluid</span>
                  <div className="flex gap-2">
                      <div className="w-8 h-8 rounded-full border-2 border-white/20"></div>
                      <div className="w-8 h-8 rounded-full border-2 border-white/20 -ml-4 bg-white/5 backdrop-blur-sm"></div>
                  </div>
               </div>
      ...
      <section className="max-w-4xl mx-auto px-4 mb-24">
         <div className="bg-slate-900 border border-slate-800 rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="flex flex-col items-center text-center">
               ...
               <h2 className="text-3xl font-bold text-white mb-6">Multichain Payments</h2>
               <p className="text-slate-400 leading-relaxed max-w-2xl mb-8">
                  Use your crypto card to make instant payments across multiple blockchain networks. Whether you're spending Bitcoin, Ethereum, or stablecoins, the card ensures smooth transaction processing with automatic currency conversion and no hidden fees.
               </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-8 border-t border-slate-800 pt-8">
               <div className="flex gap-4 items-start">
                   ...
                   <div>
                      ...
                      <p className="text-sm text-slate-400">Accepted anywhere major card networks are supported worldwide.</p>
                   </div>
               </div>
               <div className="flex gap-4 items-start">
                   ...
                   <div>
                      ...
                      <p className="text-sm text-slate-400">Set spending limits, approve transactions, and freeze card instantly from the app.</p>
                   </div>
               </div>
            </div>
         </div>
